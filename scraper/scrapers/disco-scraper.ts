...
export class DiscoScraper extends BaseScraper {
  ...
  async scrapeProducts(): Promise<ScrapedProduct[]> {
    ...
    try {
      const categories = [
        { url: 'https://www.disco.com.py/categoria-producto/lacteos/', name: 'Lácteos' },
        { url: 'https://www.disco.com.py/categoria-producto/carnes/', name: 'Carnes' },
        { url: 'https://www.disco.com.py/categoria-producto/frutas-y-verduras/', name: 'Frutas y Verduras' },
        { url: 'https://www.disco.com.py/categoria-producto/bebidas/', name: 'Bebidas' },
        { url: 'https://www.disco.com.py/categoria-producto/almacen/', name: 'Almacén' },
        { url: 'https://www.disco.com.py/categoria-producto/limpieza/', name: 'Limpieza' },
      ];
    ...
    console.log(`\n📊 Total unique products from Disco: ${uniqueProducts.length}`);
